...
public class HandleParams {
    ...
    public void parameterAssignment() {
        if ((this.iFrame instanceof FixedLengthFrame)) {
            ...
            ControlDomain_M controlDomainC = (ControlDomain_M) fixedLengthFrame.getControlDomain();
            ...
            ControlDomain_M controlDomainC = (ControlDomain_M) variableLengthFrame.getControlDomain();
            setParameterByControl(controlDomainC);
        }
    }

    public void setParameterByControl(ControlDomain_M controlDomainC) {
